...
public class DialogueManager2 : MonoBehaviour
{
    ...
    void GetMessageAndAdjustComponents()
    {
        ...
        if ("left".Equals(position.ToLower()))
        {
            ...
            name_left.text = jsonObject.Dialogues[index].Name;
        ...
        else if ("right".Equals(position.ToLower()))
        {
            ...
            name_right.text = jsonObject.Dialogues[index].Name;
        ...
        {
            if ("left".Equals(jsonObject.Dialogues[index].Position))
            {
                name_left.text = jsonObject.Dialogues[index].Name;
            ...
            else if ("right".Equals(jsonObject.Dialogues[index].Position))
            {
                name_right.text = jsonObject.Dialogues[index].Name;
                if (jsonObject.Dialogues[index].SpriteName != null)
                {
